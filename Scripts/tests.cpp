...
void tests::Test_montecarlo(void)
{
    ...
    A->montecarlo(t_0, t, S_0, I_0, h, letter, false, false);
    ...
    A->montecarlo(t_0, t, S_0, I_0, h, letter, true, false);
    ...
    A->montecarlo(t_0, t, S_0, I_0, h, letter, false, true);
    ...
    A->montecarlo(t_0, t, S_0, I_0, h, letter, true, true);
